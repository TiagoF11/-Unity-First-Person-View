...
{
    public static class FirstPersonShader
    {
        public static FirstPersonShader_FirstPersonCamera playerCamera { get; set; }
        public static FirstPersonShader_WorldCamera worldCamera { get; set; }
        ...
        {
            point = playerCamera.cam.WorldToScreenPoint(point);
            return worldCamera.cam.ScreenToWorldPoint(point);
        }
        ...
        public static GameObject Instantiate(Object original, Vector3 position, Quaternion rotation)
        {
            ...
            result.AddComponent<FirstPersonShader_Object>();
            return result;
        }
